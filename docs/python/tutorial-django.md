...
1. 在 VS Code 界面的终端窗口内，所属的虚拟环境下，执行如下列命令安装 Django 框架：
    ...
    ```bash
    python -m pip install -i https://mirrors.aliyun.com/pypi/simple django==2.1.8
    ```
